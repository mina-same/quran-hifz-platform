...
- `teachers.ts` — Exports Teacher, useTeachers, useTeacher, useCreateTeacher, useDeleteTeacher (~379 tok)
...
- `AdminStudents.tsx` — PATH_TONE — renders table (~1295 tok)
- `AdminTeachers.tsx` — AdminTeachers — renders table (~566 tok)
