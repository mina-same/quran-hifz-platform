// Canonical source: quran.com API v4 (name_arabic) cross-checked against alquran.cloud API
// (numberOfAyahs) — all 114 surahs match, total ayahs = 6236. Keep this file byte-identical
// to quran-hifz/src/quran/data/surahs.ts.
export type SurahMeta = { number: number; name: string; ayahCount: number };
