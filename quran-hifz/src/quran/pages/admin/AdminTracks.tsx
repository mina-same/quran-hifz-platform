...
export function AdminTracks() {
  ...
  return (
    <>
      ...
      {/* ════════ STUDENTS MODAL — quick roster access from the list; the
          create/edit page (AdminTrackForm) offers the same panel once a track
          exists, for adding students in the same flow. ════════ */}
      {modal?.mode === "students" && (() => {
          ...
          <div style={OVERLAY} onClick={() => setModal(null)}>
            <div style={{ ...DIALOG, maxWidth: 500 }} onClick={(e) => e.stopPropagation()}>
              <div style={{
                ...
                <button className="topbar-btn btn-ghost" style={{ padding: "5px 8px" }} onClick={() => setModal(null)}>
                  <i className="ti ti-x" />
                </button>
              </div>
