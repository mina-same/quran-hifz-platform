...
export function ParentDashboard() {
  ...
  const trackName = activeChild
    ? typeof activeChild.track === "object"
      ? activeChild.track.title
      : activeChild.track
    : "—";
      ...
      >
        ...
        <Card icon="ti-book" title="خطة الحفظ الفردية">
          ...
          <div style={{ fontSize: 12 }}>
            <HalqaRow label="المسار" value={trackName} />
            <HalqaRow
              label="الجلسة القادمة"
              value="الثلاثاء بعد الفجر"
        ...
        <Card icon="ti-bell" title="آخر الإشعارات">
          {NOTIFICATIONS.map((n, i) => (
            ...
            >
              <span style={{ color: "var(--text3)", fontSize: 11, minWidth: 42, marginTop: 2 }}>
                {n.date}
              </span>
